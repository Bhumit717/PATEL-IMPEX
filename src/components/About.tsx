...
const About = () => {
  const features = [
    ...
    "1120+ Satisfied Global Clients", 
    "ISO Certified Quality Standards",
    "24/7 Customer Support Network",
  ];

  const stats = [
    { icon: Users, number: "1120+", label: "Happy Clients", color: "text-ai-primary" },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 group animate-slide-in-left">
            <div className="space-y-6">
              <div className="inline-flex items-center px-4 py-2 bg-gray-800/80 border border-ai-primary/30 rounded-full animate-neon-flicker">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-8">
              {stats.map((stat, index) => (
                <div key={index} className="text-center group/stat cursor-pointer transform hover:scale-105 transition-all duration-300">
                  <div className="bg-gray-800/50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-ai-primary/20 hover:border-ai-primary/40 hover:shadow-ai-primary/20">
          ...
          <div className="relative group">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl transform group-hover:scale-105 transition-all duration-700 border border-ai-primary/20">
              <img
            ...
            <div className="absolute -bottom-8 -left-8 bg-gradient-to-r from-ai-primary to-ai-secondary text-white p-8 rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-300 border-4 border-gray-800">
            ...
            <div className="absolute -top-6 -right-6 bg-gray-800/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-ai-primary/30 transform hover:scale-105 transition-all duration-300">
              <div className="text-center">
