        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex space-x-3">
              {socialLinks.map((social, index) => <a key={index} href={social.href} aria-label={social.label} className={`w-12 h-12 bg-slate-700 rounded-xl flex items-center justify-center ${social.color} transition-all duration-300 hover:scale-110 hover:shadow-lg`}>
